...
export function WalletSelector() {
  ...
  <Button className="px-8 py-3 bg-black text-white rounded-full hover:bg-gray-800 transition-colors duration-300 shadow-lg"
>
    {account?.ansName ||
 ...
 <div className="flex flex-col sm:flex-row gap-4 z-10">
          <button
            className="px-8 py-3 bg-black text-white rounded-full hover:bg-gray-800 transition-colors duration-300 shadow-lg"
          >
            Connect a Wallet
          </button>   
          </div>     
